...
class SelectionCriteria:
    ...
    # 기술적 분석 기준
    price_attractiveness: CriteriaRange = field(default_factory=lambda: CriteriaRange(60.0, 100.0, 80.0, 0.4))
    technical_score: CriteriaRange = field(default_factory=lambda: CriteriaRange(50.0, 100.0, 75.0, 0.3))
    volume_score: CriteriaRange = field(default_factory=lambda: CriteriaRange(40.0, 100.0, 70.0, 0.2))
    pattern_score: CriteriaRange = field(default_factory=lambda: CriteriaRange(30.0, 100.0, 65.0, 0.1))
    
    # 리스크 관리 기준
    risk_score: CriteriaRange = field(default_factory=lambda: CriteriaRange(0.0, 50.0, 25.0, 0.3))
    volatility: CriteriaRange = field(default_factory=lambda: CriteriaRange(0.1, 0.5, 0.25, 0.2))
    confidence: CriteriaRange = field(default_factory=lambda: CriteriaRange(0.4, 1.0, 0.7, 0.3))
    max_drawdown: CriteriaRange = field(default_factory=lambda: CriteriaRange(0.0, 0.2, 0.1, 0.2))

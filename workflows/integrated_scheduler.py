    ...
    def _run_daily_performance_analysis(self):
        ...
        try:
            ...
            try:
                ...
                print("⚠️ 성과 분석 모듈 로드 실패, 기본 분석으로 대체")
...
🤖 *AI 시스템이 스스로를 지속적으로 모니터링합니다!*"""
                ...
                print("⚠️ 시스템 모니터링 모듈을 찾을 수 없습니다")

...
```
DATABASE_URL=postgresql://hantu:hantu_quant_2026@158.180.87.156:5432/hantu_quant
```
...
```bash
# PostgreSQL 복구
gunzip -c ./backup/hantu_quant_20260129.sql.gz | \
  ssh -i ~/.ssh/id_rsa ubuntu@158.180.87.156 \
  "PGPASSWORD='hantu_quant_2026' psql -U hantu -h localhost hantu_quant"
```
